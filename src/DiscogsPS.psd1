#
# Module manifest for module 'DiscogsPS'
#
# Generated by: Liam
#
# Generated on: 02/05/2018
#

@{

# Script module or binary module file associated with this manifest.
RootModule = 'DiscogsPS.psm1'
...
RequiredModules = @('Bin\DiscogsPS.Lib.dll')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Music', 'Media', 'Media-Management')
